...
class PageIndicator : ItemDecoration() {
        private val colorActive = ShowOffApplication.applicationContext().resources.getColor(R.color.teal_700)
        private val colorInactive = ShowOffApplication.applicationContext().resources.getColor(R.color.lightgreen)
